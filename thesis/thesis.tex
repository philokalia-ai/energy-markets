...
Ιδιαίτερες ευχαριστίες οφείλω στον \textbf{Δρ. Ευθύμιο Καραγγέλο} για την καθοδήγησή του στον κόσμο της βελτιστοποίησης με Julia και JuMP, με αφετηρία το Julia Meetup Athens του 2024: από την ανταλλαγή εκείνη προήλθε η διατύπωση εκκαθάρισης με περιορισμούς συμπληρωματικότητας (MPCC) που βρίσκεται στην καρδιά της συζευγμένης εκκαθάρισης του συστήματος. Οι συζητήσεις μας για τη διατύπωση προβλημάτων βελτιστοποίησης και τις τεχνικές επίλυσης υπήρξαν ανεκτίμητες για την ανάπτυξη του συστήματος.

Το αποθετήριο της εργασίας συνέχισε να εξελίσσεται και μετά τον αρχικό κορμό της, σε τρίτη διακριτή φάση: ευχαριστώ τον \textbf{Παναγιώτη Γεωργακόπουλο}, ο οποίος από το 2026 κατηύθυνε και χρηματοδότησε (Fable tokens) το πρόγραμμα που ακολούθησε --- το ευρωπαϊκό αποτύπωμα των 39 ζωνών, τις επαναλήψεις βαθμονόμησης, το ζωντανό προϊόν πρόβλεψης, το API σεναρίων και τα δημόσια αντικείμενα αναπαραγωγιμότητας --- σε συνεργασία με το Claude της Anthropic.
