#!/usr/bin/env julia
# cv23 confirm A/B: base (cv22, EUPHEMIA_DISABLE_CV23=1) vs cv23 (FR nuclear
...
# extract (read-only); realized prices scored separately via score_cv23.jl.
#
#   ARM=base|cv23  DAYS=2026-07-06,2026-07-07  OUT=/path/shard.tsv \
#     julia --project=. docs/experiments/cv23/ab_cv23.jl
...
if ARM == "base"
    ENV["EUPHEMIA_DISABLE_CV23"] = "1"
else
    delete!(ENV, "EUPHEMIA_DISABLE_CV23")
end
