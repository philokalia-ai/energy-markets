#!/usr/bin/env julia
# cv17 production backfill: full-year 39-zone multi_zone_eu record to POSTGRES.
#
...
println("cv17 BACKFILL $start_date..$end_date  cv=$(Euphemia.ENERGY_PRICES_CODE_VERSION)  " *
